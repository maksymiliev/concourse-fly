...
#https://api.github.com/repos/concourse/concourse/releases/28606684 = v6.4.0
RUN url=$(curl -s "https://api.github.com/repos/concourse/concourse/releases/28606684" \
